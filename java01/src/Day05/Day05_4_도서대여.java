				...
				for(int i =0; i<memberlist.length ; i++ ) {
					...
					if(id.equals("admin")){ 
						...
						for(int j =0; j<boardlist.length ; j++) {
							if(boardlist[j][0]==null) { //null 안쓰면 덮어 씌우기  공백찾아야함
								boardlist[j][0] = title;
							...
							System.out.println("삭제할 도서명을 입력하세요:");   String 도서명 = sc.next();		
							if( boardlist[i][0] != null && boardlist[i][0].equals(도서명) ){
							...
							System.out.println("로그아웃을 진행합니다.");	  String 로그아웃 = sc.next();	
